<template>
  <div class="member_manage">
    <memberHeader :first.sync="username" :second.sync="id" :firstPlaceholder="'请输入用户名'" :secondPlaceholder="'请输入反馈ID'"
      @firstEven="handleFilter" @secondEven="handleDownload" :btn2Loading="downloadLoading"></memberHeader>
