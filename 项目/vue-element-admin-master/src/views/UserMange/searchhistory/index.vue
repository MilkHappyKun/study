<template>
  <div class="member_manage">
    <memberHeader :first.sync="userId" :second.sync="keyword" :firstPlaceholder="'请输入用户ID'"
      :secondPlaceholder="'请输入搜索历史关键字'" @firstEven="handleFilter" @secondEven="handleDownload"
